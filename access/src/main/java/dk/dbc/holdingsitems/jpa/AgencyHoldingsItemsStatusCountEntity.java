...
@NamedQuery(name = AgencyHoldingsItemsStatusCountEntity.BY_AGENCY, query = "SELECT i.status, COUNT(i) FROM ItemEntity i WHERE i.agencyId = :agencyId GROUP BY i.status")
